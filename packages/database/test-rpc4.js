...
async function run() {
  try {
    const leader = await prisma.user.create({ data: { id: '00000000-0000-0000-0000-000000000001', email: 'test1@test.com', fullName: 'Test', globalRole: 'STUDENT', institutionalId: 'tx1', googleSub: 'google-sub-123' } });
    ...
    await prisma.event.deleteMany({ where: { id: '00000000-0000-0000-0000-000000000001' } });
    await prisma.user.deleteMany({ where: { id: '00000000-0000-0000-0000-000000000001' } });
    process.exit(0);
  }
}
run();
