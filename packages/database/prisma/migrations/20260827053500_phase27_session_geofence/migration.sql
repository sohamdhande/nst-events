-- AlterTable
ALTER TABLE "attendance_sessions" ADD COLUMN "venue_latitude" DOUBLE PRECISION;
ALTER TABLE "attendance_sessions" ADD COLUMN "venue_longitude" DOUBLE PRECISION;
ALTER TABLE "attendance_sessions" ADD COLUMN "location_accuracy" DOUBLE PRECISION;

-- 4. Modify mark_attendance to respect lazy locking and use session venue location
...
-- 5. Modify sync_offline_attendance to use session venue location
